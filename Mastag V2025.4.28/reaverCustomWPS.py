...
def Run():
	#Reaver wit new terminal && 10min delay
	cmd0 = "gnome-terminal --command='"'bash -c "'""
	cmd1 = "sudo reaver -i "+devicelist.get()+" -b "
	cmd2 = e1.get()
	cmd3 = " -vv -S -c "
	cmd4 = e3.get()
	cmd5 = " -p "
	cmd6 = e2.get()
	cmd7 = " -N; sleep 600"'"'"'"
	cmd8 = cmd0+cmd1+cmd2+cmd3+cmd4+cmd5+cmd6+cmd7
	os.system(cmd8)
...
lbl2 = Label(window, text="Enter WPS Pin        ")
